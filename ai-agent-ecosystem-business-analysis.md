...
**Business insight:**  
The 13k+ star adoption signals that **context engineering is a real engineering discipline** — not just a GPT hack. Teams want reproducible, auditable AI output. GSD is the "README-driven development" of the LLM era.
...
| **SuperPowers** | 29,000 | Agent skills framework | Anthropic alignment |
